...
//#include inc_data_overlays.js
        public var overlays : ProdOverlays = new ProdOverlays();
...
public var familiar_tsid = 'I-FAMILIAR';
public var web_api_url = 'http://www.glitch.com/';
public var world_api_url = 'http://staging.glitch.com/';
public var web_root = 'http://www.glitch.com';

public var is_dev = false;
public var is_prod = true;

public var trant_growth_enabled = true;
public var greeting_enabled = true;
...
public var default_location = {
    tsid: 'LLIF6R3R9GE1GQB',
    x: -468,
    y: -111
};

public var verb_radius = 800;
public var force_intro = true;
public var max_groups = 20;
public var max_party_size = 71;
public var garden_water_threshold = 3600;
public var garden_grow_multiplier = 1.0; // This is also in php config

public var auction_delivery_time = 600;
public var mail_delivery_time = 0;
public var mail_delivery_time_with_attachment = 7*60;

public var acl_keys_per_house_limit = 100;
public var acl_keys_per_player_limit = 100;

public var all_players = [];

public var skill_points_per_second = 10;
public var skill_learning_modifier_step = 0.05;
public var emblem_favor_cost = 1000;
public var emblem_favor_increment = 100;

public var daily_quoin_limit = 100;

public var trant_growth_multiplier = 1.00; // Adjust this to globally speed up or slow down the rates

public var rook_attack_strength = 5000;
public var rook_attack_tracker = "RHFNA9M6TPB3SS0";

// where the newxp takes you after you finish it
public var newxp_exits = [
//Alakol
    {
...
public var multiplayer_quest_locations = {
    'amazing_race' : [
        {
...
public var public_hubs = [27,40,50,51,56,58,63,64,66,71,72,75,76,78,85,86,88,89,90,91,92,93,95,97,98,99,100,101,102,105,106,107,108,109,110,112,113,114,116,119,120,121,123,125,126,128,131,133,136,137,140,141,142,143];

public var population_controls = {
    'npc_piggy': {
        per_width: 7,
        min_max: 18,
        max_max: 40
...
public var greeter_group = 'RCRIG222NHV17I8';
public var level_limit = 60;

public var buddy_limit = 1000;

public var shared_instance_manager = 'RA93I1335592VFS';
public var shared_instances = {
...
public var live_help_groups = ['RA512UITCLA22AD'];
public var newbie_live_help_groups = ['RUV56KGAMTC3BUT'];
public var global_chat_groups = ['RA9118JTCLA204I'];
public var trade_chat_groups = ['RA5DT5I72543L5R'];

public var public_machine_rooms = ['LCR101Q98A12EHH', 'LIF16EM56A12FSB', 'LA9MU59GB792T80'];

public var party_spaces = {
...
public var recipe_xp_caps = true;

public var portal_group = 'RIFQS6N3PLH2TL4';

public var teleportation_ok_streets = ['LDOOSA8V29J24I3', 'LA9QUBPI49J2MOB', 'LUV1CSSE49J2P2C']; // Streets where teleportation targets/scripts are ok, even if locked, etc
public var machine_rooms = ['LCR101Q98A12EHH', 'LIF16EM56A12FSB', 'LA9MU59GB792T80'];

public var sequence_object = 'RHVH9NN4DT63PKE';
public var enable_all_the_feats = false;

public var newxp_locations = {
...
public var hi_variants_tracker = 'RIFUKAGPIJC358O';

public var feature_hi_viral = true;
public var feature_hi_records = true;
public var feature_report_hi_records = true;


//inc_data_feats_prod.js
public var feats = {

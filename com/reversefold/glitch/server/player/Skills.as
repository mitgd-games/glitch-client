...
public function skills_init(){
    ...
    if (skills === undefined || skills === null){
        ...
        if (this.player.stats && this.player.stats.level > 1){
            log.error(this+' WARNING: Recreating skills container with level = '+this.player.stats.level);
...
public function skills_get_list(){
...
public function skillsGetLatest(){
    this.skills_init();
...
public function skills_learn_missing_recipes(){
    this.skills_init();
...
public function skills_auto_learn_recipes(skill_id, tell_client){
    ...
    //
    // This is optional, since we also call this public function in pc.onLoggedin()
...
// require this one.
//
public function skills_can_unlearn(id){
...
//
public function skills_unlearnable_list() {
    this.skills_init();
...
//
public function skills_unlearning_time(point_cost) {
...
//
public function skills_unlearn(id) {
    if (!this.skills.unlearningQueue){
        this.skills.unlearningQueue = {};
    }
...
public function skillsGetCount(){
    return this.skills.skills.__length;
}

public function skills_train(id){
    if (!this.skills.unlearningQueue){
        this.skills.unlearningQueue = {};
    }
...
public function skills_get_max_acceleration(){
...
public function skills_at_max_acceleration(){
    var skill = this.skills_get_learning();
    if (skill){
        var queue = skill.queue;
...
public function skills_start_acceleration(acceleration_duration, ignore_max){
    var skill = this.skills_get_learning();
    if (skill){
...
public function skills_stop_acceleration(){
    //
    // Tell the client
    //
...
public function skills_is_accelerated(){
    var skill = this.skills_get_learning();
    if (skill){
...
public function skills_reschedule_queue(time_change){
    //
...
public function skills_seconds_to_points(seconds, category){
...
public function skills_complete_training(){
...
public function skills_get_queue(){
    this.skills_init();
...
public function skills_get_queue_length(){
    return num_keys(this.skills_get_queue());
}

public function skills_get_unlearning_queue_length() {
    if (!this.skills.unlearningQueue) {
        this.skills.unlearningQueue = {};
    }
...
public function skills_is_learning(){
    var queue = this.skills_get_queue();
    for (var i in queue){
        if (!queue[i].is_paused){
            return true;
...
public function skills_is_unlearning(){
...
public function skills_in_learning_queue(skill) {
...
public function skills_remove_notify(id){
    if (!this.skills.unlearningQueue) {
        this.skills.unlearningQueue = {};
    }
...
public function skills_get_highest_level(skill_id){
...
public function skills_get_learning(){
    var queue = this.skills_get_queue();
...
public function skills_get_unlearning(){
    var queue = this.skills.unlearningQueue;
...
public function skills_format_queued(queue){
...
public function skills_admin_check_states(args){
    if (!this.skills.unlearningQueue) {
        this.skills.unlearningQueue = {};
    }
...
public function skills_get_learning_time_modifier(){
...
public function skills_learnable_list(is_new_style, include_locked){
...
public function get_skill_info(skill, giant, points){
...
public function get_brain_capacity(){
...
public function skills_set_brain_capacity(amount){
    this.skills.capacity = amount;
}
...
public function skills_cancel_learning(){
    this.apiCancelTimer('skills_complete_training');
    this.apiCancelTimer('skills_stop_acceleration');
    for (var i in this.skills.queue){
        delete this.skills.queue[i];
...
public function applyCategoryReduction(category_id, percent){
...
public function skills_get_active_progress(){

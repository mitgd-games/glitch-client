package com.reversefold.glitch.server.player {
    ...
    public class Announcements extends Common {
...
public function announce_sound_delayed(name, loop_count, fade_in, delay){
...
public function announce_vp_overlay(args){
    var rsp = {
        type: 'vp_overlay'
    };
...
public function announce_window_overlay(args){
    var rsp = {
        type: 'window_overlay'
    };
...
public function announce_pc_overlay(args){
    var rsp = {
        type: 'pc_overlay'
    };
...
public function announce_itemstack_overlay(args){
    var rsp = {
...
public function announce_location_overlay(args){
    var rsp = {
...
public function announce_vog_simple(txt){
...
public function announce_vog_fade(txt, args_in){
    if (!args_in) args_in = {};
...
public function run_next_overlay_script(){
...
public function dismiss_next_overlay_script(){
...
public function run_overlay_script(name){
...
public function run_overlay_done_script(name){
...
public function overlay_done_script_top_of_tree(pc){
...
public function overlay_script_top_of_tree(pc){
...
public function overlay_script_smuggling_explain_restrictions(pc){
    pc.apiSendAnnouncement({
...
public function overlay_done_script_smuggling_explain_restrictions(pc){
...
public function overlay_script_smuggling_reveal_destination(pc){
...
public function overlay_done_script_smuggling_reveal_destination(pc){
    pc.ui_callout_cancel();
...
public function overlay_script_return_to_gentle_island(pc){
...
public function announce_itemstack_bubble(stack, text, duration, follow, width, dont_keep_in_bounds){
    if (!stack) return;
...
public function announce_checkmark(txt, annc_uid, deco_name){
    var msg = {
        type: 'loc_checkmark',
        txt: txt
    };
...
public function announce_build_indicator_annc(uid){
...
public function announce_remove_indicator(uid){
    if (!this.announced_indicators || !this.announced_indicators[uid]){
        return;
    }
...
public function announce_has_indicator(uid){
    if (!this.announced_indicators){
        return false;
    }
...
public function announce_remote_item_speech(class_tsid, text, args) {
    var item_annc = {
...
public function announce_remote_item_state_change(args){

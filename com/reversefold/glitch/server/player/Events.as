package com.reversefold.glitch.server.player {
    ...
    public class Events extends Common {
        private static var log : Logger = Log.getLogger("server.player.events");
...
public function events_add(details, seconds){
    if (!details.callback){
...
public function events_remove(f){
...
public function events_trigger(details){

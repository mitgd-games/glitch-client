...
public function secretLocationsQuestLevel() {
    return 5;
}
...
public function secretLocationsQuestNumToChoose() {
    return 20;
}
...
// For testing
public function checkSecretLocations() {
    var out = [];
    var max = config.secret_spots.length;
    for (var i = 0; i < max; i ++) {
        var loc = Server.instance.apiFindObject(config.secret_spots[i].tsid);
        if (loc) {
            out.push(loc.label);
        }
        else {
...
// For testing
public function showAllSecretOverlays() {
...
public function clearAllSecretOverlays() {
    this.showAllSecrets = false;
...
public function clearRemainingSecretOverlays() {
    if (this.secret_locations) {
        var num = this.secret_locations.length;
        for (var i = 0; i < num; i ++) {
            if (    this.secret_locations[i]
...
public function fixBrokenMarker(idx) {
    if (this.secret_locations ) {
...
public function forceFixSecrets() {
    if (this.secret_locations) {
        var num = this.secret_locations.length;
        for (var i = 0; i < num; i ++) {
...
public function hasSecretLocation(loc, id) {
    if (this.secret_locations) {
        var num = this.secret_locations.length;
        for (var i = 0; i < num; i ++) {
            this.fixBrokenMarker(i);
...
public function removeSecretLocation(loc, id) {
    if (this.secret_locations) {
        var num = this.secret_locations.length;
        for (var i = 0; i < num; i ++) {
            if (    this.secret_locations[i]
...
public function showSecretLocationMarker(loc) {
    if (this.secret_locations) {
        var num = this.secret_locations.length;
        for (var i = 0; i < num; i ++) {
            this.fixBrokenMarker(i);
...
public function triggerSecretLocationMarker(loc, id) {
    if (this.secret_locations) {
        var num = this.secret_locations.length;
        for (var i = 0; i < num; i ++) {
            this.fixBrokenMarker(i);
...
public function getSecretNotification(giant){
...
public function handleElevenSecrets(id) {

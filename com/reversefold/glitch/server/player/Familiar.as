package com.reversefold.glitch.server.player {
    ...
    public class Familiar extends Common {
        private static var log : Logger = Log.getLogger("server.player.familiar");
...
public function familiar_send_alert_delayed(details, seconds){
...
public function familiar_send_alert_now(details){
...
public function familiar_send_targeted(details){
...
public function familiar_clean_queue(){
...
public function familiar_find_alerts(callback){
...
public function familiar_remove_alert(uid){
...
public function familiar_on_conversation(msg){
...
public function familiar_on_verb(msg){
...
public function familiar_test(choice, details){
...
public function familiar_get_login(){
...
public function familiar_teleport_offer(txt, tsid, x, y, force){
...
public function familiar_teleport_do(choice, details){
...
public function familiar_locked_door(choice, details){
...
public function familiar_upgrade(){
...
public function familiar_ignore_callback(choice, details){
    return {
        txt: details.txt,

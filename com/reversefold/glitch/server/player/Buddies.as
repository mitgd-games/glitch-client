...
public function buddies_get_tsids(){
...
public function buddies_is_buddy(pc){
    for (var i in this.friends){
        if (i != 'reverse' && i != 'cache'){
            for (var tsid in this.friends[i].pcs){
...
public function buddies_is_reverse(pc){
...
public function createBuddyGroup(name){
...
public function buddies_has_added(pc){
...
public function getBuddyGroup(player_tsid){
...
public function buddies_add_reverse(pc){
...
public function buddies_delete_reverse(tsid){
    delete this.friends.reverse.pcs[tsid];
    this.buddies_changed();
}

public function buddiesSendMsg(msg){
...
//
public function buddies_get_random_slice(count){
    this.buddies_init();
...
public function buddies_add_ignore(pc){
    this.buddies_init();
...
public function buddies_add_ignored_by(pc){
    this.buddies_init();
...
public function buddies_remove_ignored_by(pc){
    this.buddies_init();
...
public function buddies_get_ignoring_login(){
...
public function buddies_get_ignored_by_tsids(){
...
public function buddies_get_ignored_by_login(){
...
public function buddies_get_ignoring_count(){
    if (!this.ignoring) return 0;
    return num_keys(this.ignoring.pcs);
}

public function buddies_get_ignored_by_count(){
...
public function buddies_get_reverse_cache_tsid(){
    this.buddies_init();
    if (this.reverse_buddy_cache) return this.reverse_buddy_cache.tsid;
    return null;
}

public function buddies_add_to_cache(pc){
    this.buddies_init();
    if (!pc) return {};
...
public function buddies_get_from_cache(tsid){
...
public function buddies_remove_from_cache(tsid){
    this.buddies_init();
    delete this.friends.cache.pcs[tsid];
}

public function buddies_update_reverse_cache(){
    this.buddies_init();
...
public function buddies_reset_cache(){
    this.buddies_init();
    this.friends.cache.pcs = {};
}

public function buddies_send_buddy_offline(args){
...
public function buddies_send_buddy_online(args){
    var group_id = this.getBuddyGroup(args.tsid);
...
public function buddies_changed(){
...
public function buddies_get_simple_online_info(){

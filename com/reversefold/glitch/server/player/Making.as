...
public function making_can_use(item, verb){
...
public function making_required_skill(item, verb){
...
public function making_check_allowed(item, verb){
...
public function making_open_interface(item, verb){
...
public function computeEnergyAndTimeCost(recipe, item, count, verb) {
    //
...
public function making_make_known(msg, item){
...
public function making_get_transmogrification_time(count){
...
public function tryToMake(msg, item){
...
public function finishMakingKnown(inf){
...
// from the queue.
public function scheduleNextTimer(info) {
...
public function checkIngredients(inputs, count, remove, item){
...
public function finishMakingUnknown(inf){
...
public function makingFindBestMatch(inputs, available_recipes, exact_quantities){
    var matches = [];
...
public function makingInputsMatch(a, b, exact_counts){
...
public function making_get_recipes(item, verb){
...
public function making_get_effects(item, verb){
...
public function making_recipe_request(msg){
    var rsp = {};
...
public function making_is_making(){
    if (this.making_queue && this.making_queue.length > 0){
...
public function get_task_limit_multiplier(item){
...
//
public function machinesRunning(machine) {
...
public function machineTimeRemaining(tsid) {
    if (this.making_queue) {

package com.reversefold.glitch.server.player {
    ...
    public class Trophies extends Common {
        private static var log : Logger = Log.getLogger("server.player.Trophies");

        public var config : Config;
        public var player : Player;

        public function Trophies(config : Config, player : Player) {
            this.config = config;
            this.player = player;
        }
